...
def mainForm():
    ...
    menuFuncionarios.add_command(label='Cadastro de Funcionarios',command=cadastroFerramentas)
    menuSolicitacoes.add_command(label='Cadastro de Solicitações',command=cadastroFerramentas)
